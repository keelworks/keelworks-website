  ...
  return (
    <div className="w-screen lg:min-h-[800px] mt-[5rem] bg-white flex justify-center items-center font-Inter">
      <div className="w-full max-w-[3000px] h-full overflow-hidden relative bg-white flex justify-center items-start">
        <div className="max-w-[1600px] flex items-start md:items-center justify-center flex-col xl:h-full h-full mx-[1rem] md:mx-[2rem] lg:mx-[8rem]">
          <div>
          ...
          <div className="max-w-[1100px] md:text-[#646464] font-bold text-[25px] md:text-[30px] xl:text-[40px] md:mt-2 text-left md:text-center">
            <p>
          ...
          <div className="max-w-[1100px] text-[18px] leading-loose md:text-[24px] md:text-[#646464] mt-8 md:mt-4 text-left md:text-center">
            <p>
