...
const ContactForm = () => {
  ...
  return (
    <div className="w-screen bg-white flex justify-center items-center">
      <div className="w-screen max-w-[3000px] mt-[5rem] md:mt-[8rem] flex justify-center items-center">
              ...
              <div className="md:order-1">
                <form className="space-y-4 mt-2" onSubmit={handleSubmit}>
                  ...
                  <div className="flex justify-center lg:justify-start">
                    <button className="block mt-7 mb-[4rem] px-24 py-5 bg-action500 rounded-full hover:bg-action300 transition duration-[300ms] ease-linear text-[1rem] text-white font-semibold">
                      Send
                    </button>
                  </div>
                </form>
