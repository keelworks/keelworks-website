    ...
    <div className="w-screen">
      ...
      <div className="w-screen flex justify-center bg-grey200">
        <div className="w-full max-w-[3000px]">
          <div className="lg:mx-[8rem] md:mx-[2rem] mx-[2rem]">
          ...
          <div className="w-full">
            <p className="lg:text-[2.68rem] md:text-[2.25rem] text-[2.5rem] font-bold leading-relaxed lg:mx-[8rem] md:mx-[2rem] mx-[2rem] pt-10 lg:pb-[8rem] sm:pb-[6rem] pb-[4rem]">
              Globally,{" "}
      ...
      <div className="w-full bg-grey200 flex justify-center">
        <div className="max-w-[3000px] mx-[2rem] md:mx-[2rem] lg:mx-[8rem]">
