  ...
  return (
    <div className="">
      <div className="w-full bg-grey200">
        <div className="lg:mx-[8rem] sm:mx-[6rem] mx-[4rem]">
        ...
        <div className="w-full">
          <p className="lg:text-[2.68rem] md:text-[2.25rem] sm:text-[1.875rem] text-[1.5rem] font-bold leading-relaxed lg:mx-[8rem] sm:mx-[6rem] mx-[4rem] pt-10 lg:pb-[8rem] sm:pb-[6rem] pb-[4rem]">
            Globally,{" "}
      ...
      <div className="flex flex-col bg-white w-full lg:h-screen ">
        <div className="justify-center flex pt-[3.5rem] pb-10  ">
          <p className="text-4xl md:text-5xl lg:text-6xl font-bold ml-6 sm:ml-0 md:ml-0 lg:ml-0">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3  sm:gap-2 gap-6 lg:h-4/5">
          <div className="overflow-hidden sm:m-2 md:m-4 lg:m-4 relative group  m-2 ">
            ...
            <div className="intro h-1/6 w-full sm:p-4 md:p-2 lg:p-2 text-white absolute bottom-0 lg:group-hover:h-4/5  md:group-hover:h-3/4 group-hover:h-52 group-hover:bottom-0 transition-all duration-500 group-hover:cursor-pointer backdrop-blur-lg bg-black bg-opacity-60">
          ...
          <div className="overflow-hidden  sm:m-2 md:m-4 lg:m-4   relative group m-2">
            ...
            <div className="intro h-1/6 w-full sm:p-4 md:p-2 lg:p-2  text-white absolute bottom-0 lg:group-hover:h-4/5 md:group-hover:h-3/4 group-hover:h-52 group-hover:bottom-0 transition-all duration-500 group-hover:cursor-pointer backdrop-blur-lg bg-black bg-opacity-60">
              <div className="flex items-center justify-center w-full" style={{ margin: '20px 0' }}>
                <div className="flex items-center justify-start w-full">
                  <h1 className=" text-primary500 font-bold text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl ml-4">
                    KeelMate
                  </h1>
          ...
          <div className="overflow-hidden  sm:m-2 md:m-4 lg:m-4   relative group m-4">
            ...
            <div className="w-full h-1/6 sm:p-4 md:p-2 lg:p-2 text-white absolute bottom-0 lg:group-hover:h-4/5  group-hover:h-52 md:group-hover:h-3/4 group-hover:bottom-0 transition-all duration-500 group-hover:cursor-pointer backdrop-blur-lg bg-black bg-opacity-60 ">
              <div className="flex items-center justify-center" style={{ margin: '20px 0' }}>
                <div className="flex items-center justify-start w-full">
                  <h1 className="text-primary500 font-bold text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl ml-4">
                    KeelWings
