      ...
      <div className="flex flex-col bg-white w-full lg:h-screen ">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3  sm:gap-2 gap-6 lg:h-4/5">
          ...
          <div className="overflow-hidden  sm:m-2 md:m-4 lg:m-4   relative group m-2">
            ...
            <div className="intro h-1/6 w-full sm:p-4 md:p-2 lg:p-2  text-white absolute bottom-0 lg:group-hover:h-4/5 md:group-hover:h-3/4 group-hover:h-3/5 group-hover:bottom-0 transition-all duration-500 group-hover:cursor-pointer backdrop-blur-lg bg-black bg-opacity-60">
