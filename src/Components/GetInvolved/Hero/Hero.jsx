      ...
      <div className="w-full max-w-[3000px] h-full  overflow-hidden relative bg-[rgb(255,255,255)] flex  justify-center items-center">
        <div className="flex items-center justify-center flex-col xl:w-8/12 xl:h-full w-full h-full">
          ...
          <div className="text-[#646464] font-bold  text-[35px] md:text-[40px] md:mt-10 text-center p-[10px]">
            <p className="">Together, WE can do <span className="text-primary500 ">ANYTHING</span> </p>
          </div>
          <div className=" text-[20px] md:text-[28px] text-[#646464]  text-center p-[10px] leading-relaxed">
            <p>KeelWorks wants to help everyone to sustaining employment. We are KeelWorks! <br />The KeelMaster program can have a significant affect on poverty and boost economies.<br /> But we have to build it first. Systems are coming together, and you can be part of it!</p>
          </div>
          <div class="xl:mt-[40px] grid grid-cols-3 gap-24">
            <div class="relative  ">
            ...
            <div class="relative  ">
              ...
              <p class="text-[16px] text-[#646464]">Encourage others to donate </p>
